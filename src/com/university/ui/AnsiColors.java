...
/**
 * AnsiColors contains static final String variables for adding color to console output.
 * It uses ANSI escape codes which are compatible with most modern terminals.
 * 'static' and 'final' keywords are used as these are constant values.
 */
